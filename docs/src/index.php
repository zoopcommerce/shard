...
<div class="jumbotron masthead">
  <div class="container">
    <h1>Shard</h1>
    <p>Supercharge Doctrine ODM and Mongo DB. Document behaviours to make development fast and simple.</p>
    <p>
...
<div class="bs-docs-social">
  <div class="container">
    <ul class="bs-docs-social-buttons">
      ...
      <li>
        <iframe class="github-btn" src="http://ghbtns.com/github-btn.html?user=zoopcommerce&repo=sharde&type=fork&count=true" allowtransparency="true" frameborder="0" scrolling="0" width="102px" height="20px"></iframe>
      </li>
    </ul>
  </div>
</div>
