...
$manifest->getSubscribers(); //Array of all the event subscribers required
    ...
    <p>To configure your own document manager to your taste, override the <code>objectmanager</code> service with your own factory.</p>

<pre class="prettyprint linenums">
'service_manager_config' => [
    'factories' => [
        'objectmanager' => 'My\DocumentManager\Factory'
    ]
]
</pre>
...
$documentManager = $manifest->getServiceManager()->get('objectmanager');
</pre>
